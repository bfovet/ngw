 ...
 * </p>
 * <ul>
 *   <li>{@link gov.sandia.dart.workflow.domain.impl.NamedObjectImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class NamedObjectImpl extends MinimalEObjectImpl.Container implements NamedObject {
	...
	protected EClass eStaticClass() {
		return DomainPackage.Literals.NAMED_OBJECT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DomainPackage.NAMED_OBJECT__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DomainPackage.NAMED_OBJECT__NAME:
				return getName();
		}
