...
public class DomainFactoryImpl extends EFactoryImpl implements DomainFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case DomainPackage.RESPONSE: return createResponse();
			case DomainPackage.WF_NODE: return createWFNode();
			case DomainPackage.WF_ARC: return createWFArc();
			case DomainPackage.PROPERTY: return createProperty();
			case DomainPackage.INPUT_PORT: return createInputPort();
			case DomainPackage.OUTPUT_PORT: return createOutputPort();
			case DomainPackage.SAW_NODE: return createSAWNode();
			case DomainPackage.NOTE: return createNote();
			case DomainPackage.RESPONSE_ARC: return createResponseArc();
	 ...
	 * @generated
	 */
	public WFNode createWFNode() {
		WFNodeImpl wfNode = new WFNodeImpl();
		return wfNode;
	}
	 ...
	 * @generated
	 */
	public WFArc createWFArc() {
		WFArcImpl wfArc = new WFArcImpl();
		return wfArc;
	}
	 ...
	 * @generated
	 */
	public SAWNode createSAWNode() {
		SAWNodeImpl sawNode = new SAWNodeImpl();
		return sawNode;
	}
