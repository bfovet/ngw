...
public class InputPortEditingSupport extends EditingSupport {

        private final TableViewer viewer;
        private CellEditor editor;
		private int column;

        public InputPortEditingSupport(TableViewer viewer, int column) {
                super(viewer);
                this.viewer = viewer;
				switch (column) {
				case 0:
					 this.editor = new TextCellEditor(viewer.getTable());
		                ...
		                break;
				case 1:						
					this.editor = new StringComboBoxCellEditor(viewer.getTable(), Input.availableTypes());
			}
            this.column = column;
        }
