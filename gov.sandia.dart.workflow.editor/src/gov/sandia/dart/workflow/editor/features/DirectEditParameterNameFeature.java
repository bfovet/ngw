...
public class DirectEditParameterNameFeature extends AbstractDirectEditingFeature implements ICellEditorProvider {
 
    public DirectEditParameterNameFeature(IFeatureProvider fp) {
        super(fp);
    }
	...
	public String getInitialValue(IDirectEditingContext context) {
        ...
        return ParameterUtils.getName(parameter);
    }
 
    @Override
    public String checkValueValid(String value, IDirectEditingContext context) {
        // null means that the value is valid
        return StringUtils.isNotEmpty(value) ? null : "Parameter name must not be empty";
    }
	...
	public void setValue(String value, IDirectEditingContext context) {
        ...
        PictogramElement pe = context.getPictogramElement();
        WFNode parameter = (WFNode) getBusinessObjectForPictogramElement(pe);
        ParameterUtils.setName(parameter, value);
