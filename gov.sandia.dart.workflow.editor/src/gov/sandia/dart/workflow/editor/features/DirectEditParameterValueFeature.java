...
public class DirectEditParameterValueFeature extends AbstractDirectEditingFeature implements ICellEditorProvider {
 
    public DirectEditParameterValueFeature(IFeatureProvider fp) {
        super(fp);
    }
	...
	public String getInitialValue(IDirectEditingContext context) {
        PictogramElement pe = context.getPictogramElement();
        WFNode parameter = (WFNode) getBusinessObjectForPictogramElement(pe);
        return ParameterUtils.getValue(parameter);
    }
 
    @Override
    public String checkValueValid(String value, IDirectEditingContext context) {
        // null means that the value is valid
        return StringUtils.isNotEmpty(value) ? null : "Parameter value must not be empty";
    }
	...
	public void setValue(String value, IDirectEditingContext context) {
        ...
        PictogramElement pe = context.getPictogramElement();
        WFNode parameter = (WFNode) getBusinessObjectForPictogramElement(pe);
        ParameterUtils.setValue(parameter, value);
