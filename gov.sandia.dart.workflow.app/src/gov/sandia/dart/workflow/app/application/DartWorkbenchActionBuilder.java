 ...
 */
public final class DartWorkbenchActionBuilder extends ActionBarAdvisor {
...
//    private IContributionItem searchComboItem;
     ...
     */
    public DartWorkbenchActionBuilder(IActionBarConfigurer configurer) {
        super(configurer);
...
//     * Creates and returns the Project menu.
//     */
//    private MenuManager createServerMenu() {
//        MenuManager menu = new MenuManager("Server", IWorkbenchActionConstants.MENU_PREFIX+"server");
//        menu.add(new Separator("serverStart"));
//
//        menu.add(new GroupMarker(IWorkbenchActionConstants.MB_ADDITIONS));
//        menu.add(new GroupMarker("serverEnd"));
//
//        return menu;
//    }
    ...
    private MenuManager createToolsMenu() {
        MenuManager menu = new MenuManager("Tools", IWorkbenchActionConstants.MENU_PREFIX+"tools");
        menu.add(new Separator("toolsStart"));

        menu.add(new GroupMarker(IWorkbenchActionConstants.MB_ADDITIONS));
        menu.add(new GroupMarker("toolsEnd"));
	...
	private void addSeparatorOrGroupMarker(MenuManager menu, String groupId) {
		...
		boolean addExtraSeparators = WorkflowApplicationPlugin.getDefault()
				.getPreferenceStore().getBoolean(prefId);
		addExtraSeparators = true;
