...
public class GetOptions
{
     ...
     *   take arguments
     * @exception GetOptionsException for any error.
     */

    public GetOptions(String _argv[],
                  String _flags, String _options,
                  String _longflags[], String _longoptions[])
        throws GetOptionsException
    {
        argv = _argv;
        flags = _flags;
        options = _options;
    ...
    */
    ...
    {
        String[] strings = (String[]) optionlist.get(option);
        return strings != null ? strings[0] : dflt;
    }
    
    public int getOption(String option, int dflt) throws GetOptionsException
    {
    	try {
    		String[] strings = (String[]) optionlist.get(option);
    		if (strings == null)
    		...
    		throw new GetOptionsException("Value for option " + option + " must be an integer: " +
    										optionlist.get(option));
    	}
    }
    ...
    private void doParse() throws GetOptionsException {
        int i;
            ...
            if (moreargs) {
                ...
                if (arg.equalsIgnoreCase("--")) {
                    ...
                    if (possopts.get(arg) == Boolean.FALSE) {
                        ...
                        if (optarg == null)
                            throw new GetOptionsException("Missing argument " +
                                                      "to option " + arg);
                    }
                }
                    ...
                    for (int j = 1; j <arg.length(); j++) {
                        ...
                        if (possopts.containsKey(charatj)) {
                            ...
                            if (possopts.get(charatj) == Boolean.FALSE) {
                                ...
                                if (optarg == null)
                                    throw new GetOptionsException("Missing " +
                                                              "argument " +
                                                              "for " +
                                                              charatj);
                            }
                            ...
                            throw new GetOptionsException("Bad option: " +
                                                      charatj);
                    }
                }
                else {
