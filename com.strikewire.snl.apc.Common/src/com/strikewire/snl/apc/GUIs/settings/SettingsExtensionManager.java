...
public class SettingsExtensionManager
{
	...
	private SettingsExtensionManager()
	{
		...
		Collection<IExtensionElement<? extends IInstance>> elements = new ArrayList<IExtensionElement<? extends IInstance>>();
		elements.add(_emptySelectionEditor);
		elements.add(_emptySelectionEditorPerspectiveBinding);
		
		Map<String, IExtensionElement<? extends IInstance>> elementsByName = new HashMap<String, IExtensionElement<? extends IInstance>>();
	...
	{
		private final Map<String, T> _instances = new HashMap<String, T>();
