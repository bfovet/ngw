...
/**
 * <p>
 * An abstract class that exends Plugin, and adds IStatusReporting capabilities.
 * These extensions allow for a consistent approach for reporting Status
 * messages.
 * 
 * @author kholson
 *
 */
public abstract class AbsReportingPlugin extends Plugin implements
    IStatusReporting
{
   ...
   * 
   */
  public AbsReportingPlugin(String pluginId)
  {
    super();
