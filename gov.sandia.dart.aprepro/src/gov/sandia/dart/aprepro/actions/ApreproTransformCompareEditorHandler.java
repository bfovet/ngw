...
public class ApreproTransformCompareEditorHandler extends AbstractHandler {
	...
	{
		try {
			AbstractHandler abstractTransformHandler = new ApreproTransformHandler(DisplayOption.InCompareEditor);
